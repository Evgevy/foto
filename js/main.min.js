...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   fotoCorporate: function() { return /* binding */ fotoCorporate; }
/* harmony export */ });
var fotoCorporate = function fotoCorporate() {
  var slider = document.querySelector('[data-slider="foto-corporate"]');
  if (!slider) return;
  new Swiper(slider, {
    slidesPerView: 'auto',
    spaceBetween: 16
...
/* harmony export */ });
var slider = document.querySelector('[data-slider="foto"]');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initEventTab: function() { return /* binding */ initEventTab; }
/* harmony export */ });
var initEventTab = function initEventTab() {
  var tabSection = document.querySelector('.event-tab');
  if (!tabSection) return;
  var buttons = tabSection.querySelectorAll('[data-tab]');
  var items = tabSection.querySelectorAll('.event-tab__item');
  buttons.forEach(function (button) {
    button.addEventListener('click', function () {
      var targetSelector = button.getAttribute('data-tab');
      var targetItem = tabSection.querySelector(targetSelector);
      if (!targetItem) return;

      // Убираем активные классы
      buttons.forEach(function (btn) {
        btn.classList.remove('event-tab__btn--active');
      });
      items.forEach(function (item) {
        item.classList.remove('event-tab__item--active');
      });

      // Добавляем активные классы
      button.classList.add('event-tab__btn--active');
      targetItem.classList.add('event-tab__item--active');
    });
  });
};
...
var initMarque = function initMarque() {
  var sliderContent = document.querySelector('.tape__slider-content');
...
var initMoveHeaderElements = function initMoveHeaderElements() {
  ...
  //   if (!headerBottom.contains(headerIcons)) {
  //     headerBottom.appendChild(headerIcons); 
  //   }
  // } else {

  //   if (headerBottom.contains(headerIcons)) {
  //     headerCenter.appendChild(headerIcons);
  //   }
  // }
};
...
/* harmony import */ var _modules_foto_corporate__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/foto-corporate */ "./js/modules/foto-corporate.js");
/* harmony import */ var _modules_init_event_tab__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/init-event-tab */ "./js/modules/init-event-tab.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0,_modules_foto_corporate__WEBPACK_IMPORTED_MODULE_10__.fotoCorporate)();
    (0,_modules_init_event_tab__WEBPACK_IMPORTED_MODULE_11__.initEventTab)();
